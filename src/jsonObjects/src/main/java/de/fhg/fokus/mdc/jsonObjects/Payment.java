...
/**
 * Payment type for receiving all information (prices) about the current
 * reservation (session).
 * 
...
public class Payment {
	 ...
	 */
	@JsonIgnore
	private List<ReservationSegment> reservations;
	...
	public Payment(Userprofile userprofile, Integer reservationSequenceID,
			List<ReservationSegment> reservations) {

		this.setUserprofile(userprofile);
		this.setReservationSequenceID(reservationSequenceID);
		this.setReservationSegments(reservations);
	 ...
	 * @param segments
	 */
	public void setReservationSegments(List<ReservationSegment> segments) {
		this.reservations = segments;
	}
