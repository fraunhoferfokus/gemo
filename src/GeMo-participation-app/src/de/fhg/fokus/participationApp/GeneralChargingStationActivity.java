 ...
 */
public class GeneralChargingStationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// set the view
		setContentView(R.layout.general_charging_station_activity_fullscreen);

		// setup the required listeners
		findViewById(R.id.new_charging_station_complaint_button).setOnClickListener(newComplaintOnClickListener);
		findViewById(R.id.show_charging_station_list_button).setOnClickListener(showListOnClickListener );
	...
	View.OnClickListener newComplaintOnClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			Intent pIntent = new Intent(v.getContext(), ParticipationChargingStationActivity.class);
	...
	View.OnClickListener showListOnClickListener = new View.OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			Intent pIntent = new Intent(v.getContext(), ShowComplaintsListChargingStationActivity.class);
            startActivityForResult(pIntent , 0);
		}
	};
}
