...
public class RefreshTokenRequestTestWithFuzzing {
	...
	public RefreshTokenRequestTestWithFuzzing(String client_id,
	...
	public void testWithAllfuzzed() {
		given().contentType("application/x-www-form-urlencoded")
				...
				.param("refresh_token", _code).param("scope", _scope).expect()
	...
	public void testWithTypeAndValidClientHardcoded() {
		given()// .filter(new ErrorLoggingFilter())
