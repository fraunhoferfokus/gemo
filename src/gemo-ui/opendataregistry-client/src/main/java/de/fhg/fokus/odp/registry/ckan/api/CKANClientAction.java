...
public interface CKANClientAction {
	...
	@Produces("application/json")
	@Consumes("application/json")
	public ClientResponse<JsonNode> showUser(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
	...
	@Produces("application/json")
	@Consumes("application/json")
	public ClientResponse<JsonNode> createUser(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
	...
	@Produces("application/json")
	@Consumes("application/json")
	public JsonNode createMetadataRating(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
	...
	@Produces("application/json")
	@Consumes("application/json")
	public JsonNode getMetadataRating(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
	...
	@Produces("application/json")
	@Consumes("application/json")
	public JsonNode createMetadata(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
	...
	@Produces("application/json")
	@Consumes("application/json")
	public JsonNode updateMetadata(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
	...
	@Produces("application/json")
	@Consumes("application/json")
	public ClientResponse<JsonNode> listRelationships(
			@HeaderParam("Authorization") String authenticationKey,
			JsonNode body);
