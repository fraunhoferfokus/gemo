...
AUI().ready(function(B) {					
					...
					try {						
						...
						$('#share').socialSharePrivacy({
									...
									"layout" : "line",
									"services" : {"buffer":{"status":false},"delicious":{"status":false},"disqus":{"status":false},
										"fbshare":{"status":false},"flattr":{"status":false},"hackernews":{"status":false},
										"linkedin":{"status":false},"mail":{"status":false},"pinterest":{"status":false},
										"reddit":{"status":false},"stumbleupon":{"status":false},"tumblr":{"status":false},
										"xing":{"status":false}
								}
							});//share
						});//$(document).ready						
					  ...
					  {						
						$.getScript("/gemo-theme/js/socialshareprivacy.js", function () {						   
						$.getScript("/gemo-theme/js/modules/twitter.js", function () {	
					    $.getScript("/gemo-theme/js/modules/facebook.js", function () {
						$.getScript("/gemo-theme/js/modules/gplus.js", function () {
						$.getScript("/gemo-theme/js/locale/de/socialshareprivacy.js", function () {
						$.getScript("/gemo-theme/js/locale/de/modules/facebook.js", function () {
						$.getScript("/gemo-theme/js/locale/de/modules/twitter.js", function () {	
						$.getScript("/gemo-theme/js/locale/de/modules/gplus.js", function () {						
