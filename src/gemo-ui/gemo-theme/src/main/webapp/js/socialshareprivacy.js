...
(function ($, undefined) {
	...
	socialSharePrivacy.settings = {
		...
		'txt_help'          : 'If you activate these fields via click, data will be sent to a third party (Facebook, Twitter, Google, etc ...) and stored there. For more details click <em>i</em>.',
		...
		'cookie_expires'    : 365,
		'path_prefix'       : '',
		'css_path'          : "/gemo-theme/stylesheets/socialshareprivacy.css",
		'uri'               : getURI,
		'language'          : 'de',
